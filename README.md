...
**현재 상태**: 단위 테스트 956개, 자동 플레이로 세 시드 모두 마을 레벨 20 도달(12~14분),
...
- 개발 로드맵: [01 MVP](docs/plan/roadmap_01.md) · [02 완성도](docs/plan/roadmap_02.md) ·
  ...
  [05 남의 손에 쥐여 준다](docs/plan/roadmap_05.md) · [06 이동과 캐릭터](docs/plan/roadmap_06.md) ·
  [07 넓은 마을과 건축 외형](docs/plan/roadmap_07.md) · [08 한 손으로 행동하고, 집 안에 산다](docs/plan/roadmap_08.md)
...
| 키 | 하는 일 |
|---|---|
| 방향키 / `W` `A` `S` `D` | 걷기. 누른 채 `Space`면 그 방향 앞 칸에 행동 |
| `I` `J` `K` `L` | 정밀 겨냥·건축 부지 고르기. 마우스를 움직이면 마우스가 가져간다 |
